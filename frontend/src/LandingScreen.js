...
const LandingScreen = () => {
  ...
  const [answer, setAnswer] = useState(null); // User's response: "yes", "no", or null (no answer yet)
  ...
  return (
    ...
    >
      ...
      {!answer && (
        ...
        >
          <button onClick={() => setAnswer('yes')} style={buttonStyle('#6366f1')}>
            Yes 😺
          </button>
          <button onClick={() => setAnswer('no')} style={buttonStyle('#ef4444')}>
            No 😿
          </button>
          <button onClick={() => navigate('/random-fact')} style={buttonStyle('#10b981')}>
            Maybe 🤔
          </button>
        </div>
      )}
      ...
      {answer === 'yes' && (
        ...
        >
          ...
          <button onClick={() => navigate('/tracker')} style={buttonStyle('#6366f1')}>
            Get Started →
          </button>
        </div>
      )}
      ...
      {answer === 'no' && (
        ...
        >
          ...
          <button onClick={() => navigate('/game')} style={buttonStyle('#6366f1')}>
            Try this game →
          </button>
        </div>
      )}

      {/* Walking Cat Animation at Bottom */}
      <Lottie
